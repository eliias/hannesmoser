  ...
  return (
    <StyledNav>
      <section>
        ...
        <Link activeClassName="active" to="/experiments">Experiments</Link>
        <Link activeClassName="active" to="/journal">Journal</Link>
        <Link activeClassName="active" to="/lectures">Lectures</Link>
        <Link activeClassName="active" to="/projects">Projects</Link>
        <Link activeClassName="active" to="/talks">Talks</Link>
      </section>
    </StyledNav>
  );
}
