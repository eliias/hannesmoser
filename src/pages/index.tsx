...
const IndexPage = () => (
  <Layout>
    ...
    <Section>
      ...
      >
        I am a <Mark>software engineer,</Mark> computer science and data
        enthusiast, speaker, teacher and constant learner.
      </Heading>
      <Text>
        Currently I am working on the next generation of information retrieval
        systems and discovery experiences at{" "}
        <a href="https://shopify.com">Shopify</a>. Me and my team
        are building the platform for search relevance, recommender systems
        and scalable streaming systems.
        {/*We operate data-informed, adhere to*/}
        {/*first principles and like to make research a reality in production.*/}
      </Text>
      <Text>
        My <a href="https://neele.codes">partner</a> and I, spend our free time{" "}
        <a href="https://www.strava.com/athletes/20638565">running</a>,{" "}
        <a href="https://github.com/spurtli/foodies">cooking</a>, learning new
        things like{" "}
        <a href="https://www.datacamp.com/">data science & machine learning</a>{" "}
        and{" "}
      ...
      <Text>
        ...
        of companies such as <a href="https://s3.medel.com/pdf/US/Continents-and-Oceans.pdf">MED-EL</a>,{" "}
        <a href="https://www.redbullcontentpool.com/">Red Bull</a> and{" "}
        <a href="https://www.redbullcontentpool.com/">Wiberg</a>.
        My contributions include, but are
        not limited to, technical decision making, R&D, mentoring and leading
        teams.
      </Text>
      <Text>
        ...
        <Link to="/talks">speaking</Link> about web development and academia at
        conferences and when I participate in community events such as
    ...
    <Section wide>
      ...
      <Heading level="h5">
        <a href="/">Faster inter-service communication with streams</a>
      </Heading>
      <Text>
        A system of distributed services can provide some benefits over
        monoliths and we embrace the idea of small services at Spurtli. In this
        article I’d like to bring attention to a performance problem that we
        recently had in one of our projects and how we solved it.
      </Text>
      <a>Read more…</a>
    </Section>
    <Section wide>
          ...
          <TimelineItem>
            <ol>
              <li style={{ marginBottom: "5rem" }}>
                ...
                >
                  Spearheaded Shopify’s efforts in the field of Search Relevance
                  across multiple applications (Storefront, Back-office). Help
                  building the next generation of scalable and world-class
                  solutions for Wayfinding with a great team of software and
                  relevance engineers, data scientists, UX specialists and
            ...
            <ol>
              <li>
                ...
                <Text>
                  ...
                  Sciences Salzburg. Additionally to teaching, I helped develop
                  the latest curriculum (MSc) and also organize events and
                  meetups for students and the local dev community.
                </Text>
                <footer>
                  <a href="#">Academia</a>
                </footer>
