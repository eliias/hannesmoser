...
export type LatestArticlesQueryVariables = Exact<{ [key: string]: never; }>;


export type LatestArticlesQuery = { latestArticles: { nodes: Array<{ excerpt?: string | null, frontmatter?: { title?: string | null, slug?: string | null } | null }> } };
